...
import supplementary.ShowMessageB;
...
//    private Image image = new ImageIcon("lib/1.png").getImage();
    ...
    private void startUdpServer() {
        ShowMessageB smb = new ShowMessageB(jTextArea1);
        ServerProtocolUDP protocolUDP = new ServerProtocolUDP(smb);
        Server_UDP server_UDP = new Server_UDP(9999, protocolUDP, smb);
    }
