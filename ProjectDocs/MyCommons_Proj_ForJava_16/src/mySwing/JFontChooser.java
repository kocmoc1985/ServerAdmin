...
public final class JFontChooser extends JComponent
    ...
    private static final Font DEFAULT_FONT = new Font("Tahoma", Font.PLAIN, 12) /*new Font("Dialog", Font.PLAIN, 10)*/;
    ...
    public String getSelectedFontStyleStr()
        {
        int index = getFontStyleList().getSelectedIndex();
        String[] fontStyleNames1 = getFontStyleNames();
        return fontStyleNames1[index];
        }
    ...
    protected JPanel getFontFamilyPanel()
        ...
        if (fontNamePanel == null)
            ...
            fontNamePanel.setPreferredSize(new Dimension(210, 180));
    ...
    public static String getFontStyleStr(int style)
        {
        String[] fontStyleNames1 =
            {
            "Plain", "Bold", "Italic", "BoldItalic"
            };
        return fontStyleNames1[style];
        }
